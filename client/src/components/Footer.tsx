...
const Footer: React.FC = () => {
  return (
    <footer className="bg-red-700 border-t border-red-700">
      ...
      <img src="/MB-Logo.png" alt="Moez Binz Logo" className="h-8 md:h-10 w-auto mr-3" />
          ...
          {/* Customer Support */}
          <div>
            <h3 className="text-sm font-semibold text-white tracking-wider uppercase mb-2">Customer Support</h3>
            <ul className="space-y-1">
        ...
        <div className="mt-4 border-t border-red-800 pt-4 flex flex-col sm:flex-row items-center justify-between">
          <div className="text-center sm:text-left order-2 sm:order-1 mt-2 sm:mt-0">
